...
async def not_chat(_, m: Message):
    ...
    k=await m.reply_photo(photo="https://s6.uupload.ir/files/untitled-1_g44s.png", caption="**Sorry, You Can't Use This Bot In This Group!", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
